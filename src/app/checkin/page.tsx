...
export default function CheckinPage() {
  ...
  const handleSignIn = async () => {
    ...
    try {
      ...
      setSigninResult({ success: false, message: '网络错误，请重试' })
    }
    setSigningIn(false)
  }
  ...
  if (!session) {
    return (
      <div className="max-w-2xl mx-auto px-4 py-20 text-center">
        ...
        <p className="text-gray-500 mb-6">登录后查看签到和积分</p>
        <Link
          href="/signin"
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">坚持签到，赢取积分奖励</p>
        </div>
        <Link
          href="/"
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
        <div className="grid grid-cols-3 gap-4 text-center">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500 mt-1">⭐ 经验</div>
          </div>
          <div>
        ...
        <div className="mb-4">
          ...
          <div className="space-y-1.5 text-sm">
            <div className="flex justify-between py-1.5 px-3 rounded-lg bg-gray-50">
              <span className="text-gray-600">每日签到基础积分</span>
