...
本项目已部署在线演示站，你可以直接体验全部功能：

| 页面 | 链接 | 说明 |
|------|------|------|
| 🏠 **首页** | [https://780417.xyz](https://780417.xyz) | 社区首页，浏览帖子、签到、个人信息 |
| 🔧 **管理后台** | [https://780417.xyz/admin](https://780417.xyz/admin) | 管理员面板，管理用户、帖子、分类、站点配置 |

**管理员账号：**

| 角色 | 邮箱 | 密码 |
|------|------|------|
| 管理员 | `admin@dongbaihu.com` | `admin123` |

> ⏰ **注意**：演示站数据库每天凌晨 00:00 自动重置为初始状态，
